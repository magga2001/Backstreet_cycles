...
object TestAppModule {
    ...
    fun provideUserRepository(
        ...
        return FakeUserRepoImpl(firstName, lastName, email, password)
    }

    @Provides
    @Singleton
    fun provideMapboxRepository(route: DirectionsRoute): MapboxRepository {
        return FakeMapboxRepoImpl(route)
    }
    ...
    fun provideEmail(): String{
        return "backstreet.cycles.test.user@example.com"
    }
