...
class SignUpViewModelTest {
    ...
    fun test_sign_up_user_fail_with_invalid_email_and_invalid_password() = runBlocking {
        ...
        assert("Password is too short"== signUpViewModel.getMessage().getOrAwaitValue())
    }
    ...
    fun test_sign_up_user_fail_with_invalid_email_and_valid_password() = runBlocking {
        ...
        assert("Invalid email, cannot send email"== signUpViewModel.getMessage().getOrAwaitValue())
    }
    ...
    fun test_sign_up_with_existed_account() = runBlocking {
        signUpViewModel.register("John","Doe","johndoe@example.com","123456")
        signUpViewModel.register("John","Doe","johndoe@example.com","123456")
        assert("Email already existed"== signUpViewModel.getMessage().getOrAwaitValue())
    }
