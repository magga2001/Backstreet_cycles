...
import com.example.backstreet_cycles.databinding.ActivityJourneyOnMapBinding
...
class JourneyMapActivity : AppCompatActivity() {
     ...
     */
    private val viewBinding: ActivityJourneyOnMapBinding by lazy {
        ActivityJourneyOnMapBinding.inflate(layoutInflater)
    }
        ...
        mapboxMap.loadStyleUri(
            ...
            object : OnMapLoadErrorListener {
                override fun onMapLoadError(eventData: MapLoadingErrorEventData) {
                    Log.e(
                        ActivityJourneyOnMapBinding::class.java.simpleName,
    ...
    private fun startSimulation(route: DirectionsRoute) {
        mapboxReplayer.run {
            stop()
            clearEvents()
            pushRealLocation(this@JourneyMapActivity, 0.0)
